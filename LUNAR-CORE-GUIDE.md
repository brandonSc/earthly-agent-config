...
- **Claude reviews PRs automatically** when they are opened or updated via the `claude-code-action` GitHub Action. You can also `@claude` in a PR comment to ask questions.
